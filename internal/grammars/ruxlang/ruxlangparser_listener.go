...
// RuxlangParserListener is a complete listener for a parse tree produced by RuxlangParser.
type RuxlangParserListener interface {
	...
	// EnterPipeType is called when entering the pipeType production.
	EnterPipeType(c *PipeTypeContext)
	...
	// ExitPipeType is called when exiting the pipeType production.
	ExitPipeType(c *PipeTypeContext)
